...
| `logo-square.svg` (1:1) | ☐ pending export (DEV-3877) | Claude Connectors Directory |
| `logo-64.png` (64×64, **under 5KB**) | ☐ pending export (DEV-3877) | OpenAI Plugin Directory |
| `logo-400.png` (400×400) | ☐ pending export (DEV-3877) | Cline |
